  ...
  async function handleSubmit(formData: FormData) {
    ...
    try {
      ...
      if (result.success) {
        ...
        // Reset form
        const form = document.getElementById("vacancy-contact-form") as HTMLFormElement
        if (form) {
          form.reset()
        }
      } else {
  ...
  return (
    <Card className="border-0 shadow-lg sticky top-24">
      <CardHeader>
        ...
        <CardDescription>Interested in this property? Contact us now.</CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        <form id="vacancy-contact-form" action={handleSubmit} className="space-y-4">
        ...
        <div className="pt-4 border-t">
          <p className="text-xs text-muted-foreground text-center mb-3">Need immediate assistance?</p>
