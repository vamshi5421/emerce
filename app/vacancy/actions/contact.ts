...
export async function submitVacancyInquiry(formData: FormData) {
  ...
  try {
    ...
    const FORMSPREE_ENDPOINT = process.env.FORMSPREE_ENDPOINT || "https://formspree.io/f/xdkogkvo"
    ...
    return {
      success: true,
      message: "Thank you for your interest! We'll contact you within 24 hours with more details about this property.",
    }
  } catch (error) {
